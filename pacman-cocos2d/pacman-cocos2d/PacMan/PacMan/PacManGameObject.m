...
@implementation PacManGameObject
...
-(void) setCurrentDirection:(NavigationDirection)currentDirection{
    ...
    if (currentDirection == NavigationDirectionLeft){
...
-(void)die{
    ...
    [self runAction:[CCSequence actions:[CCRotateBy actionWithDuration:1.2 angle:720], [CCCallBlock actionWithBlock:^{
        [self setCurrentDirection:NavigationDirectionRight];
